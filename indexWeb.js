...
const cargarFotos = async() => {
    try {
        const respuesta = await fetch(`https://corsproxy.io/?https://maps.googleapis.com/maps/api/place/textsearch/json?query=cities+argentina&key=${apiKey}`);
        // const respuesta = await fetch(`https://corsproxy.io/?https://maps.googleapis.com/maps/api/place/details/json?placeid=ChIJCULTGU3ZhJURJtH-S4Bwlt0&key=${apiKey}`);
